...
import apexLogo from './assets/tech_logo/apexlogo.png';
import adobeanalyticslogo from './assets/tech_logo/adobeanalyticslogo.png';

// Experience Section Logo's
import sflogo from './assets/company_logo/sflogo.png';
import pitlogo from './assets/company_logo/pitlogo.png';
import amazonlogo from './assets/company_logo/amazonlogo.jpg';
...
export const SkillsInfo = [
  ...
  },
  {
    ...
    skills: [
      ...
      {name: 'Adobe Analytics', logo: adobeanalyticslogo},
    ],
  },
];
  ...
  export const experiences = [
    ...
    },
    {
      ...
      desc: "During my AWS Cloud Virtual Internship, I gained hands-on experience in cloud computing by working with core AWS services such as EC2 for virtual server management, S3 for data storage, and RDS for database solutions. I learned to deploy, monitor, and scale applications in the cloud, implemented security best practices through IAM, and worked on infrastructure automation and cost optimization. Through real-world projects and scenarios, I applied cloud architecture principles and collaborated on solutions that reflected industry use-cases, which significantly enhanced my practical skills and prepared me for professional opportunities in IT and cloud technology.",
      skills: [
         "Cloud Computing", "AWS EC2", "Amazon S3", "Database Management", "Cloud Security", "Infrastructure Automation", "Application Deployment", "IAM (Identity and Access Management)", "Cost Optimization", "Monitoring and Scaling",
      ],
    },
